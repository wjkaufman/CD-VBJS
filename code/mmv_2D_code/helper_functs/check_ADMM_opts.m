function opts = check_ADMM_opts(opts)
...
if ~isfield(opts,'nonuniform_grid')
    opts.nonuniform_grid = false;
end
...
% for displaying final convergence plots
if ~isfield(opts,'disp_conv')
    opts.disp_conv = 0; 
end
