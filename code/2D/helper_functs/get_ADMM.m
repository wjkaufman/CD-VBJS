function [U,mu,beta,muf,betaf,muDbeta,sigma,...
    delta,gL,ind,out] = get_ADMM(p,q,r,Atb,scl,opts,k,b,wrap_shrink)
...
if ~flg
    x1;
    x2;
    warning('Sparse domain transforms do not appear consistent');
end

% initialize multiplers
sigma = D(zeros(p,q,r),1);                       
